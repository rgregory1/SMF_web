...
def print_hero(hero, basedir):
	...
	if len(hero['hero_archetype_list']) == 1:
		if hero['hero_archetype_list'][0]['archetype'] == 'Henchmen':
			...
			draw.text((333,119), henchman_name, fill='#505050', font=heroid_large)
		else:
			draw.text((333,119), hero['hero_name'], fill='#505050', font=heroid_large)
		draw.text((522,205), hero['hero_archetype_list'][0]['archetype'], fill='#505050', font=heroid_large)
	if len(hero['hero_archetype_list']) == 2:
		super_name = hero['hero_name'] + ' (Super)'
		draw.text((333,119), super_name, fill='#505050', font=heroid_large)
	...
	if len(hero['hero_archetype_list']) == 3:
		...
		draw.text((333,119), powerhouse_name, fill='#505050', font=heroid_large)
		draw.text((522,205), hero['hero_archetype_list'][1]['archetype'], fill='#505050', font=heroid_large)
	...
	if hero['hero_archetype_list'][0]['archetype'] == 'Henchmen':
		draw.text((408,367), str(hero['numbers']), fill='#505050', font=heroid_large)
	else:
		# print out the hero's body
		draw.text((294,367), str(hero['body_points']), fill='#505050', font=heroid_large)

		# print out the hero's psyche
		draw.text((348,473), str(hero['psych_points']), fill='#505050', font=heroid_large)

	# print out the hero's melee attack and defence
	draw.text((515,585), str(hero['melee_attack']), fill='#505050', font=heroid_large)
	if hero['melee_attack_rr'] > 0:
	    draw.text((620,585), str(hero['melee_attack_rr']), fill='#505050', font=heroid_large)
	draw.text((1222,585), str(hero['melee_defence']), fill='#505050', font=heroid_large)
	if hero['melee_defence_rr'] > 0:
	    draw.text((1327,585), str(hero['melee_defence_rr']), fill='#505050', font=heroid_large)

	# print out the hero's ranged attack and defence
	if 'ranged_attack' in hero:
		draw.text((515,697), str(hero['ranged_attack']), fill='#505050', font=heroid_large)
	if hero['ranged_attack_rr'] > 0:
		draw.text((620,697), str(hero['ranged_attack_rr']), fill='#505050', font=heroid_large)
	draw.text((1222,697), str(hero['ranged_defence']), fill='#505050', font=heroid_large)
	if hero['ranged_defence_rr'] > 0:
		draw.text((1327,697), str(hero['ranged_defence_rr']), fill='#505050', font=heroid_large)

	# print out the hero's psyche attack and defence
	if 'psyche_attack' in hero:
		draw.text((515,811), str(hero['psyche_attack']), fill='#505050', font=heroid_large)
	if hero['psyche_attack_rr'] > 0:
		draw.text((620,811), str(hero['psyche_attack_rr']), fill='#505050', font=heroid_large)
	draw.text((1222,811), str(hero['psyche_defence']), fill='#505050', font=heroid_large)
	if hero['psyche_defence_rr'] > 0:
		draw.text((1327,811), str(hero['psyche_defence_rr']), fill='#505050', font=heroid_large)

	# if len(hero['hero_major_power_list']) > 1:
	majorpower_height = 1013
	for majorpower in hero['hero_major_power_list']:
		draw.text((119, majorpower_height), majorpower['power_name'], fill='#505050', font=heroid_large)
		majorpower_height = majorpower_height + 40

	minorpower_height = 1013
	for minorpower in hero['hero_minor_power_list']:
		draw.text((797, minorpower_height), minorpower['power_name'], fill='#505050', font=heroid_large)
