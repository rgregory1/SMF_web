...
def setup_arch():
	...
	if hero['hero_archetype_list'][0]['power_type'] == 'Standard' or hero['hero_archetype_list'][0]['power_type'] == 'Henchmen' or hero['hero_archetype_list'][0]['power_type'] == 'Street Level':
...
def minor_power_launch():
	...
	if arch['archetype'] == 'Blaster' and current_major_power['power_name'] == 'Archery':
		...
		print('we have an archer')
		print(arch['archer_minor_p_list'])
		if 'Amphibious' not in arch['archer_minor_p_list']:
			arch['archer_minor_p_list'].append('Amphibious')
		if 'Construct-Speed' not in arch['archer_minor_p_list']:
			arch['archer_minor_p_list'].append('Construct-Speed')
		if 'Construct-Tough' not in arch['archer_minor_p_list']:
			arch['archer_minor_p_list'].append('Construct-Tough')
	...
	# create regular minor power dict
		...
		current_minor_power_dict = {}
		if 'Amphibious' not in arch['minor_p_list']:
			arch['minor_p_list'].append('Amphibious')
		if 'Construct-Speed' not in arch['minor_p_list']:
			arch['minor_p_list'].append('Construct-Speed')
		if 'Construct-Tough' not in arch['minor_p_list']:
			arch['minor_p_list'].append('Construct-Tough')
		for x in min_power_dict:
